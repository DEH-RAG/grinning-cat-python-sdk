...
from grinning_cat_python_sdk.models.api.rabbit_holes import (
    AllowedMimeTypesOutput,
    UploadSingleFileResponse,
    UploadUrlResponse,
)
from grinning_cat_python_sdk.utils import deserialize, file_attributes


class RabbitHoleEndpoint(AbstractEndpoint):
    def __init__(self, client: "Grinning CatClient"):
    ...
    def post_file(
        ...
        The Grinning Cat processes the injection in background and the client will be informed at the end of the process.
    ...
    def post_memory(
        ...
        format. The Grinning Cat processes the injection in the background, and the client will be informed at the end of
        the process.
        :param file_path: The path to the file to upload.
        :param agent_id: The ID of the agent.
